(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("posterlens", [], factory);
	else if(typeof exports === 'object')
		exports["posterlens"] = factory();
	else
		root["posterlens"] = factory();
})(window, function() {
...
/* harmony import */ var _posterlens_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _posterlens_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_posterlens_css__WEBPACK_IMPORTED_MODULE_0__);
/*
 * Posterlens
 * Version 2.1
 ...
 */
 ...
 /**
  * I tried in many ways to include three.js and panolens.js in this file, so we only have to import one library.
  * But there were always errors, in one way or the other. The npm module of panolens is obsolete, the good one doesnt include THREE, and including THREE as a module doesnt load the panorama src ...
  * CONCLUSION: the Three and panolens scripts must be included with <script> before the posterlens
  */

//import * as THREE from './panolens/three.min'; import * as THREE from 'three'; import {THREE} from 'panolens-three'
...
(function(quindow) {
    ...
    var Posterlens = function(el) {
        ...
        const updateObjectParams = function(object, params) {
            ...
            object.name = params.name? params.name : 'poster_'+Math.floor(Math.random() * (10000)); ;
        ...
        self.getObjectByName = (name, pano) => (pano? pano : self.viewer.panorama).getObjectByName(name) ;
        ...
        self.getMouse3DPosition = () => {                                        
                                        ...
                                        while ( i++ < intersects.length )
                                            if (intersects[i] && intersects[i].object.name === 'invisibleWorld') {
...
function glowAnimation( object, duration = 200 ) { 
    ...
    function glowAnimationForward(object, duration) {
        ...
        if (!object.glowAnimationOriginalScale) 
            object.glowAnimationOriginalScale = Object.assign({}, object.scale );
